 ...
 */
var DOTW = ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday"]
for day in DOTW {
    print(day)
}
/*: question2
 ...
 */
print("")
let numDOTW = [1,2,3,4,5]
for number in numDOTW {
    print("\(number)) \(DOTW[number - 1])")
}
 ...
 */
print("")
//var emptyArray : [String] I kept getting an error because i'm checknig if its empty before its initialized.  Wasn't sure how to solve for that.
var emptyArray = ["Test"]
